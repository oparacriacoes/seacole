...
class InsumosOferecidosProjeto2 extends ChartComponent
{
    protected string $componentView = 'components.charts.insumos-oferecidos-projeto2';

    public function chartData(): array
    {
        $collection = collect();
        $filters = array_slice(MateriaisEntreguesEnum::readables(), 3, 3, true);
