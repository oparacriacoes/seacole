  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>CONDIÇÕES DE SAÚDE</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- CONDIÇÕES DE SAÚDE - INÍCIO (GRÁFICO 28) -->
    <div class="col">
        <div class="mb-3 card">
            ...
            <div class="card-body">
              <div class="chart" id="condicoes_saude"></div>
            </div>
        </div>
    </div>
    <!-- CONDIÇÕES DE SAÚDE - FIM -->
  </div>
</div>
@endsection
...
axios.get('/admin/chart/condicoes_saude')
  .then(response => {
    ...
    var chart = am4core.create("condicoes_saude", am4charts.XYChart);
