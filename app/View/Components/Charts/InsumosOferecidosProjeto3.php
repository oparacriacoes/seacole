...
class InsumosOferecidosProjeto3 extends ChartComponent
{
    protected string $componentView = 'components.charts.insumos-oferecidos-projeto3';

    public function chartData(): array
    {
        $collection = collect();
        $filters = array_slice(MateriaisEntreguesEnum::readables(), 6, 2, true);
