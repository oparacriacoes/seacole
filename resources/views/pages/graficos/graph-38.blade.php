  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>COMO ACESSA O SISTEMA DE SAÚDE?</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- COMO ACESSA O SISTEMA DE SAÚDE? - INÍCIO (GRÁFICO 14) -->
    <div class="col">
        <div class="mb-3 card">
            <div class="card-header-tab card-header-tab-animation card-header">
                <div class="card-header-title">
                      COMO ACESSA O SISTEMA DE SAÚDE?
                </div>
            </div>
            <div class="card-body">
              <div class="chart" id="como_acessa_sistema_saude"></div>
            </div>
        </div>
    </div>
    <!-- COMO ACESSA O SISTEMA DE SAÚDE? - FIM -->
  </div>
</div>
@endsection
...
axios.get('/admin/chart/como_acessa_sistema_saude')
  .then(response => {
    ...
    var chart = am4core.create("como_acessa_sistema_saude", am4charts.XYChart);
