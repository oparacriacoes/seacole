    ...
    echo 'checked=checked';
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input name="data_ultima_ida_servico_de_saude" type="text"  class="form-control date" id="data_ultima_ida_servico_de_saude" value="@if($internacao) {{ $internacao->data_ultima_ida_servico_de_saude }} @endif">
                                        </div>
                                    </div>
                                </div>
    ...
    echo 'checked=checked';
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input name="data_entrada_internacao" id="data_entrada_internacao"  type="text" class="date form-control" value="@if($internacao) {{ $internacao->data_entrada_internacao }} @endif">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="data_alta_hospitalar">Data da alta hospitalar</label>
                                            <input name="data_alta_hospitalar" id="data_alta_hospitalar"  type="text" class="date form-control" value="@if($internacao) {{ $internacao->data_alta_hospitalar }} @endif">
                                        </div>
                                    </div>
                                </div>
