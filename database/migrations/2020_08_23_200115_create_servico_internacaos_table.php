...
class CreateServicoInternacaosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('servico_internacaos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('servico_internacaos');
    }
}
