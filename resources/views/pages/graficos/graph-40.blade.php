  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>DIAGNÓSTICO DE COVID-19</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- DIAGNÓSTICO DE COVID-19 - INÍCIO (GRÁFICO 14) -->
    <div class="col">
        <div class="mb-3 card">
            ...
            <div class="card-body">
              <div class="chart" id="diagnostico_covid_19"></div>
            </div>
        </div>
    </div>
    <!-- DIAGNÓSTICO DE COVID-19 - FIM -->
  </div>
</div>
@endsection
...
axios.get('/chart/como_acessa_sistema_saude')
  .then(response => {
    ...
    var chart = am4core.create("diagnostico_covid_19", am4charts.XYChart);
    ...
    {
      "Confirmado":
        {"Branco": 52,"Indígena": 0,"Amarelo": 0,"Negro": 61,"Não info.": 2},
      "Suspeito":
        {"Branco": 45,"Indígena": 0,"Amarelo": 0,"Negro": 67,"Não info.": 2},
      "Descartado":
        {"Branco": 9,"Indígena": 0,"Amarelo": 0,"Negro": 12,"Não info.": 1},
      "Não info.":
        {"Branco": 41,"Indígena": 1,"Amarelo": 0,"Negro": 87,"Não info.": 20}
    }*/
