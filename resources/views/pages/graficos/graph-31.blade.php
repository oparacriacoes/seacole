  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>CONDIÇÕES DE SAÚDE (3)</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- CONDIÇÕES DE SAÚDE (SAÚDE MENTAL) - INÍCIO (GRÁFICO 31) -->
    <div class="col">
        <div class="mb-3 card">
            ...
            <div class="card-body">
              <div class="chart" id="condicoes_saude_saude_mental"></div>
            </div>
        </div>
    </div>
    <!-- CONDIÇÕES DE SAÚDE (SAÚDE MENTAL) - FIM -->
  </div>
</div>
@endsection
...
axios.get('/admin/chart/condicoes_saude_saude_mental')
  .then(response => {
    ...
    for(var i=0;i<response.data.length;i++){
      ...
      dataSet[response.data[i].doenca_cronica] = {
    ...
    var chart = am4core.create("condicoes_saude_saude_mental", am4charts.XYChart);
    ...
    {
      "Ansiedade":
        {"Branco": 35,"Indígena": 0,"Amarelo": 0,"Negro": 62,"Não info.": 4},
      "Depressão":
        {"Branco": 8,"Indígena": 1,"Amarelo": 0,"Negro": 21,"Não info.": 1},
      "Demência":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
      "Outras questões de saúde mental":
        {"Branco": 13,"Indígena": 1,"Amarelo": 0,"Negro": 21,"Não info.": 1}
    }*/
