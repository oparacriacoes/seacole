...
class CondicoesSaudeA extends ChartComponent
{
    protected string $componentView = 'components.charts.condicoes-saude-a';

    public function chartData(): array
    {
        $collection = collect();
        $doencas_cronicas = array_slice(DoencasCronicasEnum::readables(), 0, 4, true);
