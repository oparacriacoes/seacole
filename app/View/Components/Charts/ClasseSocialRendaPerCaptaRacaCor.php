...
class ClasseSocialRendaPerCaptaRacaCor extends ChartComponent
{
    protected string $componentView = 'components.charts.classe-social-renda-per-capta-raca-cor';
    ...
    private $query = "
        ...
        FROM
            ...
            SELECT
                CASE
                    WHEN renda_residencia / numero_pessoas_residencia > 0
                    AND renda_residencia / numero_pessoas_residencia <= 1254 THEN 'Classe E'
                    WHEN renda_residencia / numero_pessoas_residencia >= 1255
                    AND renda_residencia / numero_pessoas_residencia <= 2004 THEN 'Classe D'
                    WHEN renda_residencia / numero_pessoas_residencia >= 2005
                    AND renda_residencia / numero_pessoas_residencia <= 8640 THEN 'Classe C'
            ...
            FROM
                pacientes
            GROUP BY renda_residencia, numero_pessoas_residencia, cor_raca
            ) TBB
