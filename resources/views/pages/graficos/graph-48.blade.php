  ...
  <div class="row">
    ...
    <div class="col">
        <div class="mb-3 card">
            ...
            <div class="card-body">
              <div class="chart" id="sequelas"></div>
            </div>
        </div>
    </div>
    <!-- SEQUELAS - FIM -->
...
axios.get('/admin/chart/sequelas')
  .then(response => {
    ...
    var chart = am4core.create("sequelas", am4charts.XYChart);
    ...
    /*var data =
    {
      "Perda persistente de paladar":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
      "Tosse persistente":
        {"Branco": 2,"Indígena": 0,"Amarelo": 0,"Negro": 3,"Não info.": 0},
      "Falta de ar persistente":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 3,"Não info.": 0},
      "Dor de cabeça persistente":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 1},
      "Eventos tromboliticos":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
      "Danos renais":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0}
    }*/
