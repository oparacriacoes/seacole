...
class CondicoesSaudeB extends ChartComponent
{
    protected string $componentView = 'components.charts.condicoes-saude-b';

    public function chartData(): array
    {
        $collection = collect();
        $doencas_cronicas = array_slice(DoencasCronicasEnum::readables(), 4, 4, true);
