  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>INTERNAÇÃO PELO QUADRO</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- INTERNAÇÃO PELO QUADRO - INÍCIO (GRÁFICO 56) -->
    <div class="col">
        <div class="mb-3 card">
            <div class="card-header-tab card-header-tab-animation card-header">
                <div class="card-header-title">
                      INTERNAÇÃO PELO QUADRO
                </div>
            </div>
            <div class="card-body">
              <div class="chart" id="internacao_pelo_quadro"></div>
            </div>
        </div>
    </div>
    <!-- INTERNAÇÃO PELO QUADRO - FIM -->
  </div>
</div>
@endsection
...
axios.get('/chart/internacao_pelo_quadro')
  .then(response => {
    ...
    var chart = am4core.create("internacao_pelo_quadro", am4charts.XYChart);
    ...
    /*var data =
    {
      "Ambulância financiada pelo projeto?":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 2,"Não info.": 0},
      "Internação pelo quadro (suspeito ou confirmado)?":
        {"Branco": 5,"Indígena": 0,"Amarelo": 0,"Negro": 14,"Não info.": 0}
    }*/
