  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>CONDIÇÕES DE SAÚDE (2)</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- CONDIÇÕES DE SAÚDE (2) - INÍCIO (GRÁFICO 29) -->
    <div class="col">
        <div class="mb-3 card">
            <div class="card-header-tab card-header-tab-animation card-header">
                <div class="card-header-title">
                      CONDIÇÕES DE SAÚDE (2)
                </div>
            </div>
            <div class="card-body">
              <div class="chart" id="condicoes_saude_2"></div>
            </div>
        </div>
    </div>
    <!-- CONDIÇÕES DE SAÚDE (2) - FIM -->
  </div>
</div>
@endsection
...
axios.get('/admin/chart/condicoes_saude_2')
  .then(response => {
    ...
    var chart = am4core.create("condicoes_saude_2", am4charts.XYChart);
    ...
    {
      "Asma / Bronquite":
        {"Branco": 20,"Indígena": 0,"Amarelo": 0,"Negro": 19,"Não info.": 1},
      "Outras doenças Respiratórias":
        {"Branco": 9,"Indígena": 0,"Amarelo": 0,"Negro": 9,"Não info.": 0},
      "Tuberculose ativa":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
      "Já teve tuberculose?":
        {"Branco": 0,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
      "Tabagismo":
        {"Branco": 12,"Indígena": 0,"Amarelo": 0,"Negro": 20,"Não info.": 1}
    }*/
