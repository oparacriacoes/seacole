  ...
  <div class="app-page-title">
      <div class="page-title-wrapper">
          <div class="page-title-heading">
              ...
              <div>LOCAL DE INTERNAÇÃO</div>
          </div>
      </div>
  </div>
  <x-chart-list/>
  <div class="row">
    <!-- LOCAL DE INTERNAÇÃO - INÍCIO (GRÁFICO 58) -->
    <div class="col">
        <div class="mb-3 card">
            ...
            <div class="card-body">
              <div class="chart" id="local_internacao"></div>
            </div>
        </div>
    </div>
    <!-- LOCAL DE INTERNAÇÃO - FIM -->
  </div>
</div>
@endsection
...
axios.get('/admin/chart/local_internacao')
  .then(response => {
    ...
    var chart = am4core.create("local_internacao", am4charts.XYChart);
    ...
    /*var data =
    {
      ...
      "Hospital municipal do Ipiranga (encaminhado pelo projeto)":
        {"Branco": 2,"Indígena": 0,"Amarelo": 0,"Negro": 5,"Não info.": 0},
      "Hospital privado financiado pelo projeto":
        {"Branco": 1,"Indígena": 0,"Amarelo": 0,"Negro": 0,"Não info.": 0},
    }*/
