...
class CondicoesSaudeD extends ChartComponent
{
    protected string $componentView = 'components.charts.condicoes-saude-d';

    public function chartData(): array
    {
        $collection = collect();
        $doencas_cronicas = array_slice(DoencasCronicasEnum::readables(), 12, 4, true);
