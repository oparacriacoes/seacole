...
class IdaSistemaSaudePrescricoesMedicas3 extends ChartComponent
{
    protected string $componentView = 'components.charts.ida-sistema-saude-prescricoes-medicas3';
